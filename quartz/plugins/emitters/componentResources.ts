...
function addGlobalPageResources(
    ...
    `);
	} else if (cfg.analytics?.provider === "custom") {
		componentResources.afterDOMLoaded.push(`
      const customScript = document.createElement("script");
      customScript.src = "${cfg.analytics.host}${cfg.analytics.scriptPath ?? "/api/script.js"}";
      customScript.setAttribute("data-site-id", "${cfg.analytics.siteId}");
